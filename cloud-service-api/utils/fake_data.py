...
def fakedata():
        ...
        t = Trabajador("sergi", "garcia", "meh@gmail.com","245363Y", "foto_chula", 4674387249, "sergi.ib", "mehmeh123", "jefe", "Activo", datetime.today(), "Amigo de la infancia?", e.id_estacion)
        db.session.add(t)
        db.session.commit()
