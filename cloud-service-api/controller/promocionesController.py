...
def get_promo_estaciones(id_promo):
    ...
    if p:
        ...
        a = p.estaciones
        for estacion in a:
            estacion = EstacionSchema().dump(estacion)
            lista_estaciones.append(estacion["id_estacion"])
...
def post_promociones(estaciones, descuento, fecha_inicio, fecha_fin, estado, descripcion):
    ...
    for estacion in estaciones:
        i = Estacion.query.filter(Estacion.id_estacion == estacion).one_or_none()
