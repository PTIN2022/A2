...
app.config['MQTT_BROKER_URL'] = 'a2_brokercloud.craaxkvm.epsevg.upc.es'  # use the free broker from HIVEMQ
app.config['MQTT_BROKER_PORT'] = 42069  # default port for non-tls connection
